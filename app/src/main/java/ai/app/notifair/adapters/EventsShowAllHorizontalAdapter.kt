...
class EventsShowAllHorizontalAdapter :
    RecyclerView.Adapter<EventsShowAllHorizontalAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.events_show_all_horizontal_item, parent, false)
