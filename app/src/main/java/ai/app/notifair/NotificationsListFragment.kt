 ...
 * Use the [NotificationsListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NotificationsListFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view:View = inflater.inflate(R.layout.fragment_notifications_list, container, false)
